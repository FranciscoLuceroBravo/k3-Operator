...
# This file was *autogenerated* from the file m_max_minus2to4.sage
from sage.all_cmdline import *   # import sage library

_sage_const_1 = Integer(1); _sage_const_2 = Integer(2); _sage_const_3 = Integer(3); _sage_const_4 = Integer(4); _sage_const_50 = Integer(50); _sage_const_0 = Integer(0); _sage_const_1001 = Integer(1001); _sage_const_100 = Integer(100)
import requests
import pandas as pd

# 1. Descarga y preparación de referencia OEIS (A003273)
print("Descargando y procesando OEIS A003273...")
...
# 2. Construcción de base de datos con exclusión secuencial
resultados_totales = set()
analisis_por_m = []

# Regímenes de m definidos por el usuario
regimenes = [
...
for etiqueta, func_m in regimenes:
    ...
    for n in range(_sage_const_2 , _sage_const_1001 ):
        m = func_m(n)
        if m <= _sage_const_0 : continue  # Evitar valores no positivos
        ...
        # Excluir resultados de corridas previas
        if sf_N not in resultados_totales:
            nuevos_en_esta_corrida.add(sf_N)
    
    # Evaluar cobertura OEIS de los nuevos hallazgos
